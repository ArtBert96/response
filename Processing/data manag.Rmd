...
CHA$c1 <- gsub ("Con qualche difficoltà", "1", as.character(CHA$c1))
CHA$c1 <- gsub ("Con tranquillità", "2", as.character(CHA$c1))
...
CHA$d2 <- gsub ("Alleggerire un pò le misure adottate", "1", as.character(CHA$d2))
CHA$d2 <- gsub ("Mantenere le stesse misure adottate finora", "2", as.character(CHA$d2))
CHA$d2 <- gsub ("Rendere un pò più severe le misure adottate", "3", as.character(CHA$d2))
CHA$d2 <- gsub ("Rendere molto più severe le misure adottate", "4", as.character(CHA$d2))
...
CHA$e1 <- gsub ("- Si può avere fiducia nella maggior parte delle persone", "", as.character(CHA$e1))
CHA$e1 <- gsub ("- È meglio essere diffidenti", "", as.character(CHA$e1))
...
CHA$f2 <- gsub ("Più esposto", "3", as.character(CHA$f2))
CHA$f2 <- gsub ("Molto più esposto", "4", as.character(CHA$f2))
CHA$f2[ CHA$f2 == "NA" ] <- NA
...
CHA$f3 <- gsub ("Più esposto", "3", as.character(CHA$f3))
CHA$f3 <- gsub ("Molto più esposto", "4", as.character(CHA$f3))
CHA$f3[ CHA$f3 == "NA" ] <- NA
